...
goog.inherits(P.Plot.Arc, esri.geometry.Polyline);
...
goog.inherits(P.Plot.AttackArrow, esri.geometry.Polygon);
...
goog.inherits(P.Plot.Circle, esri.geometry.Polygon);
...
goog.inherits(P.Plot.ClosedCurve, esri.geometry.Polygon);
...
goog.inherits(P.Plot.Curve, esri.geometry.Polyline);
...
goog.inherits(P.Plot.DoubleArrow, esri.geometry.Polygon);
...
goog.inherits(P.Plot.Ellipse, esri.geometry.Polygon);
...
goog.inherits(P.Plot.FineArrow, esri.geometry.Polygon);
...
goog.inherits(P.Plot.GatheringPlace, esri.geometry.Polygon);
...
goog.inherits(P.Plot.Lune, esri.geometry.Polygon);
...
goog.inherits(P.Plot.Sector, esri.geometry.Polygon);
...
goog.inherits(P.Plot.StraightArrow, esri.geometry.Polyline);
...
goog.inherits(P.Plot.Polyline, esri.geometry.Polyline);
...
goog.inherits(P.Plot.FreehandLine, esri.geometry.Polyline);
...
goog.inherits(P.Plot.Polygon, esri.geometry.Polygon);
...
goog.inherits(P.Plot.Marker, esri.geometry.Point);
...
goog.inherits(P.Plot.Rectangle, esri.geometry.Polygon);
...
goog.inherits(P.Plot.FreehandPolygon, esri.geometry.Polygon);
...
P.PlotDraw = function(map){
    ...
    this.drawOverlay = new esri.layers.GraphicsLayer();
...
P.PlotDraw.prototype.mapFirstClickHandler = function (e) {
    ...
    this.drawOverlay.add(this.feature);
...
P.PlotDraw.prototype.drawEnd = function (feature) {
    this.drawOverlay.remove(this.feature);
    this.activateMapTools();
    this.disconnectEventHandlers();
